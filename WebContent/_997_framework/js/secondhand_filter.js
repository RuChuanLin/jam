...
function GoUsedItemDetail(usedItem, seller) {
  console.log(usedItem, seller, sessionStorage.getItem('LoginId'));
  if (seller == sessionStorage.getItem('LoginId')) {
    window.location.assign(`/Jam/secondhand_detail_self.html?itemId=${usedItem}`);
  } else {
